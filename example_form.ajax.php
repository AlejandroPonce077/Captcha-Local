...
<fieldset>
<legend>Registro captcha</legend>

<p class="note">
  Procesamiento de informacion personal.<br />
  Usando captcha.
</p>

<div id="success_message" style="display: none">¡Captcha correcto!</div>
...
function process_si_contact_form()
{
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && @$_POST['do'] == 'contact') {
        ...
        $errors = array();  // initialize empty error array
            ...
            //Validando campo nombre y correo
